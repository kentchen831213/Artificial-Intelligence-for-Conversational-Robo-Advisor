...
$( document ).ready(function() {
	...
	var request = function(e) {
		...
		function response(){
			if (state == 0){
				speak('Please Wait')
                $(".chat").append('<li class="clearfix"><div class="message row"></div><div class="col s10 m10 l10 chat-body clearfix left"><img src="/img/AIWISFIN.png" alt="User Avatar" class="mfr circle responsive-img" align="left"><p class="left">Please wait</p></div></li>');
				$(".panel-body").stop().animate({
					scrollTop: $(".panel-body")[0].scrollHeight
				}, 1000);}
		}
